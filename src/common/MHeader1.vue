    ...
    <div>
      <header class="w">
        <div class="w-box">
          ...
          <div class="right-box">
            <div class="nav-list">
              <el-input placeholder="请输入商品信息" prefix-icon="el-icon-search" v-model="productInfo" minlength="1" maxlength="100">
              </el-input>
                  ...
                  <div class="nav-user-list">
                    <div class="full" v-show="totalNum">
                                  ...
                                  <div class="item-desc">
                                    <div class="cart-cell">
                                      ...
                                      <h6><span class="price-icon">¥</span><span
                                          class="price-num">30</span><span class="item-num">x
                                          2</span>
                                      </h6>
                                    </div>
                                  </div>
                      ...
                      <div class="nav-cart-total">
                        <p>共 <strong>30</strong> 件商品</p>
                        <h5>合计：<span class="price-icon">¥</span><span class="price-num">1000</span></h5>
                        <h6>
...
<script>
  // import YButton from '/src/components/YButton'
  import { mapMutations, mapState } from 'vuex'
  // import { getCartList, cartDel, getQuickSearch } from '/src/api/goods'
  // import { loginOut, navList } from '/src/api/index'
