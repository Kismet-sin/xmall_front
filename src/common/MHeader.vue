                  ...
                  <div class="nav-user-list">
                    <ul>
                      ...
                      <li class="nav-user-avatar">
                        ...
                        <p class="name">{{userInfo.username||'未知用户'}}</p>
                      </li>
                      <li>
                  ...
                  <div class="nav-user-list">
                    <div class="full">
                      ...
                      <div class="nav-cart-items">
                        <ul>
                          <li class="clearfix" v-for="(goods, i) in cartList" :key="i">
                            <div class="cart-item">
                              <div class="cart-item-inner">
                                ...
                                <div class="del-btn del" @click="delGoods(goods.productId)">删除</div>
                              </div>
                            </div>
                          </li>
                        </ul>
                    ...
                    <div v-if='!totalNum' style="height: 313px;text-align: center" class="cart-con">
                      <p>您的购物车竟然是空的!</p>
                    </div>
                  </div>
                </div>
...
import { removeStore, setStore,getStore } from '@/utils/storage'
export default {
  data() {
    return { productInfo: '' }
  },
  computed: {
    ...mapState([
      'cartList', 'login', 'showCart', 'userInfo'
    ]),
    totalNum(){
  ...
  created() {
    console.log('Header login:', this.login);
    console.log('Header userInfo:', this.userInfo);
